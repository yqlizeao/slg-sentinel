...
| 模块 | 说明 |
|------|------|
| 🖥 **企业级大盘 (GUI)** | 极简 Linear/Vercel 风格的 Streamlit 控制台，一站式管理采集、横向对比并透视指标约束矩阵。具有动态排序长列表视图及交互防溢出高度锁定设计。全站强制 Light 工业白底模式。 |
| ⚙️ **多维监控策略引擎** | 首创二维「策略深度」探针网关，支持动态分离 【基础免登 vs 受限凭证】与【简易广域扫图 vs 单体深度下钻】的笛卡尔积。智能感知风控，针对性截断如分享/投币等易触发限流的深潜指标。 |
