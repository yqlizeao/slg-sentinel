...
def render_settings_page() -> None:
    ...
    with cmd_cols[0]:
        with st.popover(t('popover.targets'), use_container_width=True):
            st.caption(t("settings.targets_help"))
    ...
    with cmd_cols[1]:
        with st.popover(t('popover.secrets'), use_container_width=True):
            st.caption(t("settings.secrets_help"))
